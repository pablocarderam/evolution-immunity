...
path_save = 'tentative_figs/fig3_immunity_effect_over_evolution/immunity_effect_over_evolution_weights_dist_simple/not_grouped_recomb_off'
...
# # w2 = [0.1,0.1,0.15,0.25,0.4]  # increasing weightse
...
for key, elem in exps.items():    
    ...
    t_f = 2500 # final timepoint
    model.run(0,t_f,time_sampling=200)
    ...
    graph_composition = model.compositionPlot(
        ...
        data,
        type_of_composition='Immunity', 
        y_label='Genomes in immune memory',
        num_top_sequences=8,
        )
    ...
    graph_compartments = model.compartmentPlot(
        ...
        # track_specific_sequences=['3 A, 0 B','2 A, 1 B','1 A, 2 B','0 A, 3 B'],
        )
